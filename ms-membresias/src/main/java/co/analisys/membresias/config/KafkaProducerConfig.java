...
public class KafkaProducerConfig {
    ...
    public static final String ENTRENAMIENTO_RESUMEN_TOPIC = "entrenamiento-resumen";
    ...
    @Bean
    public NewTopic entrenamientoResumenTopic() {
        return TopicBuilder.name(ENTRENAMIENTO_RESUMEN_TOPIC)
                .partitions(3)
                .config(TopicConfig.RETENTION_MS_CONFIG, "604800000")
                .build();
    }
